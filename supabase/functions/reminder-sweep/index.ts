...
// OneSignal DESCARTA o que não entregou dentro do ttl — que aqui é de 15 min,
// justamente o caso do "Ligar em 3 min". Mensagem de Telegram chega por FCM
// nativo e nunca é descartada.
//
